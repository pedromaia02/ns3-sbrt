...
\GNUPLOTpicture(7200,5040)
  \special{psfile=images/pstex/simple_-82_0_ftpLambda_2_5_Wifi_throughput.ps llx=0 lly=0 urx=360 ury=252 rwi=3600}
  \put(5873,803){\rjust{\strut{}operador B (Wi-Fi)}}%
  \put(5873,1003){\rjust{\strut{}operador A (Wi-Fi)}}%
  \put(3909,140){\cjust{\strut{}Vazão [Mbps]}}%
  \put(160,2719){%
