...
\GNUPLOTpicture(7200,5040)
  \special{psfile=images/pstex/simple_eD_-72_0_udpRate_500Kbps_Wifi_throughput.ps llx=0 lly=0 urx=360 ury=252 rwi=3600}
  \put(5873,803){\rjust{\strut{}operator B (Wi-Fi)}}%
  \put(5873,1003){\rjust{\strut{}operator A (Wi-Fi)}}%
