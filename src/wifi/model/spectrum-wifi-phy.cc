...
SpectrumWifiPhy::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::SpectrumWifiPhy")
    ...
    .AddAttribute ("ShortPlcpPreambleEnabled",
                   ...
                   BooleanValue (false),
                   MakeBooleanAccessor (&SpectrumWifiPhy::GetShortPlcpPreamble,
                                        &SpectrumWifiPhy::SetShortPlcpPreamble),
                   MakeBooleanChecker ())
...
bool
SpectrumWifiPhy::GetShortPlcpPreamble (void) const
{
  return m_plcpPreamble;
}

void
SpectrumWifiPhy::SetShortPlcpPreamble (bool preamble)
{
